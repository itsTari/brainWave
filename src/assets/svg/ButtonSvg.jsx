const ButtonSvg = (color) => (
  <>
    ...
    >
      <path
        fill={color ? "white" : "none"}
        stroke={color ? "white" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={color ? "white" : "none"}
        stroke={color ? "white" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"

        ...
        <div className='flex-1'>
            ...
            <div className='flex items-center justify-between'>
                <ul className='flex -m-0.5 '>
                    {notificationImages.map((image, id)=>(
                        <li key={id} className='flex w-6 h-6 border-2 border-n-12 overflow-hidden '><img src={image} className='w-full rounded-full' width={20} height={20} alt='image'/></li>
                    ))}
                </ul>

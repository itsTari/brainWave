      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className='absolute bottom-4 left-4 right-4 border border-n-1/10 md:left-1/2  md:bottom-8 md:-translate-x-1/2'/>
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                {/* for the first grid element */}
                <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                  ...
                  <div className="absolute flex flex-col inset-0 justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                    ...
                    <p className="body-2 mb-[1rem] text-n-3">Automatically enhance your photos using our AI app&apos;s photo editing feature. Try it now! </p>
                  </div>
                </div>
                {/* for the second grid element */}
                <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                    <div className="py-12 px-4 xl:px-8">
                        ...
                        <ul className="flex items-center justify-between">
                          {brainwaveServicesIcons.map((item, id) =>(
                            <li key={id} className={`flex items-center justify-center rounded-2xl ${id ===2? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]': 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
                              <div className={`${id === 2? 'bg-n-7 w-full h-full flex items-center justify-center rounded-2xl':''}`}>
